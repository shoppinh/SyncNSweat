  ...
  const [workouts, setWorkouts] = useState([
    {
      ...
      completed: true,
      exercises: [
        { id: '1-1', name: 'Bench Press', sets: 3, reps: '8-10', completed: true },
        { id: '1-2', name: 'Pull-ups', sets: 3, reps: '8-10', completed: true },
        { id: '1-3', name: 'Shoulder Press', sets: 3, reps: '8-10', completed: true },
      ],
    },
    {
      id: '2',
      ...
      exercises: [
        ...
        { id: '2-2', name: 'Deadlifts', sets: 4, reps: '8-10', completed: false },
        { id: '2-3', name: 'Lunges', sets: 3, reps: '12-15', completed: false },
        { id: '2-4', name: 'Calf Raises', sets: 3, reps: '15-20', completed: false },
      ],
    },
    {
      id: '3',
      ...
      exercises: [
        ...
        { id: '3-2', name: 'Russian Twists', sets: 3, reps: '20', completed: false },
        { id: '3-3', name: 'Mountain Climbers', sets: 3, reps: '30 sec', completed: false },
  ...
  const renderWorkoutItem = ({ item }) => (
    <TouchableOpacity style={styles.workoutCard}>
      <View style={styles.workoutHeader}>
        <Text style={styles.workoutDate}>{new Date(item.date).toLocaleDateString('en-US', { weekday: 'long', month: 'short', day: 'numeric' })}</Text>
      ...
      <View style={styles.exercisesList}>
        {item.exercises.map(exercise => (
          <View key={exercise.id} style={styles.exerciseItem}>
            ...
            <Text style={styles.exerciseDetails}>{exercise.sets} sets × {exercise.reps}</Text>
          </View>
        ))}
      </View>
